                ...
                <div class="card-body">
                    ...
                    {{ method_field('PUT')}}
                        <div class="form-group">
                            <label>Name</label>
                            <input type="text" name="name" value="{{ $tasks->Name}}" class="form-control border rounded-0" disabled>
                        </div>
                        <div class="form-group">
                            <label>Description</label>
                            <div type="text" name="description"  class="form-control border rounded-0" disabled>{!! $tasks->Description !!}</div>
                        </div>
                        <div class="form-group">
                            <label>prize</label>
                            <input type="text" name="prize" value="{{$tasks->prize}}" class="form-control border rounded-0" disabled>
                        </div>
                        {{-- <label class="form-label">Proof:</label> --}}
                        {{-- <input type="file" name="image[]" class="form-control border rounded-0" value=""  multiple required> --}}
